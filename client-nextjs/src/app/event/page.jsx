...
import { fetchEvents, searchEvent, filterEventById } from "@/redux/action/eventActions";
...
const Events = () => {
  ...
  const handleFilterByEventType = (event) =>{
		dispatch(filterEventById(event.target.value))
	}
  ...
  return (
    <Container>
        ...
        <div className="lg:w-1/4 lg:pr-4 mb-3 lg:mb-0">
         <Filters eventTypes={eventTypes} handleFilterByEventType={handleFilterByEventType}/>
        </div>
